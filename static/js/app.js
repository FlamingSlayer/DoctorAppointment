 ...
 * UPDATED to match website HTML structure
 */

// ==========================================
// Configuration
// ==========================================
const API_BASE_URL = 'http://127.0.0.1:8000/api'; // Match your URLs
  ...
  try {
    ...
    setTimeout(() => {
      if (user.role === 'patient') {
        ...
        window.location.href = 'admin-dashboard.html'; // Changed from admin-dashboard.html
      } else {
...
// ==========================================
// Toast Notifications (UPDATED to match your style)
// ==========================================
...
// ==========================================
// UI Component Renderers (UPDATED for your HTML)
// ==========================================
function renderHeader() {
  ...
  // Check if we're in admin portal (different header structure)
  const isAdminPortal = window.location.pathname.includes('admin-dashboard.html');
